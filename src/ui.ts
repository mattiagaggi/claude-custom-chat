...
<body data-telemetry-enabled="${isTelemetryEnabled}">
		...
		<div class="input-container" id="inputContainer">
			...
			<div class="textarea-container">
				<div class="textarea-wrapper">
					<textarea class="input-field" id="messageInput" placeholder="Type your message to Claude..." rows="1"></textarea>
	...
	<!-- Push to Branch dialog -->
	<div id="pushToBranchModal" class="tools-modal" style="display: none;">
		<div class="tools-modal-content" style="width: 500px;">
			<div class="tools-modal-header">
				<span id="pushBranchModalTitle">🚀 Push to Branch</span>
				<button class="tools-close-btn" onclick="hidePushToBranchModal()">✕</button>
			</div>
			<div style="padding: 20px;">
				<p style="margin-top: 0; color: var(--vscode-descriptionForeground);">
					Select a branch to push your changes to, or enter a new branch name to create it.
				</p>
				<div style="margin-top: 16px;">
					<label for="pushBranchSelect" style="display: block; margin-bottom: 8px; font-weight: 600;">Target Branch:</label>
					<select id="pushBranchSelect" onchange="handleBranchSelectChange()" style="width: 100%; padding: 8px; border: 1px solid var(--vscode-input-border); background: var(--vscode-input-background); color: var(--vscode-input-foreground);">
						<option value="">Loading branches...</option>
					</select>
					<div id="customBranchInput" style="display: none; margin-top: 8px;">
						<input type="text" id="customBranchName" placeholder="feature/my-new-feature" style="width: 100%; padding: 8px; border: 1px solid var(--vscode-input-border); background: var(--vscode-input-background); color: var(--vscode-input-foreground);" />
					</div>
					<div id="currentBranchInfo" style="margin-top: 8px; font-size: 12px; color: var(--vscode-descriptionForeground);"></div>
				</div>
				<div style="margin-top: 16px;">
					<label for="pushBranchCommitMessage" style="display: block; margin-bottom: 8px; font-weight: 600;">Commit Message:</label>
					<textarea id="pushBranchCommitMessage" placeholder="Describe your changes..." style="width: 100%; min-height: 80px; padding: 8px; border: 1px solid var(--vscode-input-border); background: var(--vscode-input-background); color: var(--vscode-input-foreground); resize: vertical;"></textarea>
				</div>
				<div style="margin-top: 16px; display: flex; gap: 8px; justify-content: flex-end;">
					<button class="btn outlined" onclick="hidePushToBranchModal()">Cancel</button>
					<button class="btn primary" id="pushBranchButton" onclick="confirmPushToBranch()">Push</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="settingsModal" class="tools-modal" style="display: none;">
		<div class="tools-modal-content">
			<div class="tools-modal-header">
				<span>Claude Custom Chat Settings</span>
